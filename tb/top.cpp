...
/*** START OF EDITABLE SECTION ***/
        ...
        wfile_mem.write_file( "wfile.out", 0, 12, 0, INT2STR); // Example wfile.out for writing
        // use the appropiate "conv_format" tag for your file kind from: INT2STR, UINT2STR, FLOAT2STR, BYTE2CHAR

        rwnum_mem.write_file( "rwnum.out", 0, SYS_RWNUM_RAM_SIZE, 0, INT2STR); // Example rwnum.out for writing
